      ...
      <Panel>
        <Settings>
          <Sort>
            ...
            <Select onChange={onSortChange}  style={{fontSize:'20px', fontFamily:'Arial, Helvetica, sans-serif'}} type="select">
              {sorted ? <Option value="" style={{fontSize:'20px'}}>View all</Option> : null}
              {categories &&
                categories.map((category, index) => (
                  <Option key={index} value={category} style={{fontSize:'20px', fontFamily:'Arial, Helvetica, sans-serif'}}>
                    {category}
                  </Option>
                ))}
